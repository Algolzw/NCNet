...
same as MATLAB's results, visual_results
'''
import os
import math
import numpy as np
...
def main():
    ...
    folder_GT = '/data/dataset/aim22/aimsr/DIV2K_valid_HR'
    folder_Gen = 'results'

    crop_border = 4
    suffix = 'x3'  # suffix for Gen images
    ...
    for i, img_path in enumerate(img_list):
        ...
        print('{:3d} - {:25}. \tPSNR: {:.6f} dB'.format(
            i + 1, base_name, PSNR))
        PSNR_all.append(PSNR)
        # SSIM_all.append(SSIM)
    print('Average: PSNR: {:.6f} dB'.format(
